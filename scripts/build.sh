#!/usr/bin/env bash
# Builds Sortomat.app from the command line and reveals it in Finder on success.
...
set -euo pipefail
export BUILD_APP_NAME="Sortomat"
export BUILD_KIND="xcode"
export BUILD_XCODE_PROJECT="Sortomat.xcodeproj"
export BUILD_XCODE_SCHEME="Sortomat"
